  ...
  $.getJSON(flickrURL, function() {
    ...
    .done(function(val) {
        ...
        $.each(result, function(i, val) {
            ...
            var photoURL = "https://farm" + farmId + ".staticflickr.com/" + serverId + "/" + id + "_" + secret + "_b.jpg"
            $("#carouselInner").append("<div class='carousel-item w-100 h-100'>" +
            "<img class='w-100 h-100' src='" + photoURL +"' />" +
              "</div>");
            });
        })
      .fail(function() {
